...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        '''Tets auth required to call API'''
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_detail(self):
        '''Test recipe details to specific recipe'''
    ...
    def test_tag_on_update(self):
        '''Test creaing tag when updating a recipe'''
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_tag(self):
        '''Assigning an existing tag when updating recipe'''
    ...
    def test_create_recipe_with_new_ingredients(self):
        '''Creating recipe with new ingredinets'''
        payload = {
    ...
    def test_create_recipe_with_existing_ingredient(self):
        '''Test creating ingredient with existing ingredient'''
        ingredient = Ingredient.objects.create(user=self.user, name='Lemon')
        payload = {
            'title': 'Vietnamese Soup',
            'time_minutes': 25,
            'price': Decimal('2.55'),
            'ingredients': [{'name': 'Lemon'}, {'name': 'Fish Broth'}]
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipes =Recipe.objects.filter(user=self.user)
    ...
    def test_update_recipe_assign_ingredient(self):
        '''Test assign existing ingredient when updating a recipe'''
